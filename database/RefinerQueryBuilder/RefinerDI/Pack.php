<?php
  namespace RefinerDI;
  use RefinerQueryBuilder\QueryExtension;
class Pack
{
    /**
     * @var array
    ...
    {
        if ($alias) {
            AliasFacade::setRefinerdiInstance($this);
            class_alias('\\RefinerDI\\AliasFacade', $alias);
        }
    }
   ...
   * If there is a class registered with Pack::set() then it's instance
